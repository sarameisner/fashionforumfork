  ...
  return (
    <>
      ...
      <div className="  lg:ml-[60px] lg:mr-[240px]">
        ...
        <div className="pt-20">
          <h2 className="p-5 ml-5 sm:m-0 pb-10">Fashion Forum på lyd</h2>
          <Cards categori="" minId={11} maxId={13} selectedTag={selectedTag} />
          <Knap1 text="Se alle" link="/podcast" />
        </div>
        <div className="mb-20">
          <JobCards minId={5} maxId={8} designColor="#E6E5E5" />
          <Knap1 text="Se alle" link="/jobportal" />
        </div>
        <MostReads minId={14} maxId={19} />
        <h2 className="p-5 pb-10 pt-20">Flere nyheder</h2>
        <Cards categori="" minId={20} maxId={25} selectedTag={selectedTag} />
        <News />
        <Footer />
      </div>
    </>
